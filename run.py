...
# Callback data
SELECT_INFO, SELECT_POSITION, SELECT_ORDER, SELECT_TRAILING, SELECT_CLOSEFULL, SELECT_CLOSEPART = "select_info", "select_position", "select_order", "select_trailing", "select_closefull", "select_closepart"
...
def command_updateenv(update: Update, context: CallbackContext) -> int:
  ...
  update.effective_message.reply_text("Please enter the text to update the environment.")
